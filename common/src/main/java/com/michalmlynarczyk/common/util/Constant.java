...
public class Constant {
    ...
    public static final String WORKSHOP_JOIN_APPLICATION_APPROVED_QUEUE = WORKSHOP_SERVICE_BROKER_EXCHANGE + "-" +
            WORKSHOP_JOIN_APPLICATION_APPROVED_ROUTING_KEY + "-" + AUTHENTICATION_SERVICE_BROKER_EXCHANGE;
}
